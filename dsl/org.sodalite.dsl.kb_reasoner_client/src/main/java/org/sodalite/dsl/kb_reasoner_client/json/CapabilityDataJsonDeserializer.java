...
public class CapabilityDataJsonDeserializer extends ReasonerDataJsonDeserializer<Capability> {    
	public CapabilityDataJsonDeserializer() {
		super(new CapabilityData(), Capability.class);
	}
}
