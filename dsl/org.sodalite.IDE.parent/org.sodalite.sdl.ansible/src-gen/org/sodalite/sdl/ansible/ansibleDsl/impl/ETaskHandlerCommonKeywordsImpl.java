...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ETask Handler Common Keywords</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sodalite.sdl.ansible.ansibleDsl.impl.ETaskHandlerCommonKeywordsImpl#getError_handling <em>Error handling</em>}</li>
 *   <li>{@link org.sodalite.sdl.ansible.ansibleDsl.impl.ETaskHandlerCommonKeywordsImpl#getAction <em>Action</em>}</li>
 ...
 * @generated
 */
public class ETaskHandlerCommonKeywordsImpl extends MinimalEObjectImpl.Container implements ETaskHandlerCommonKeywords
{
  /**
   ...
   * @generated
   */
  protected ETaskHandlerCommonKeywordsImpl()
  {
    super();
  }
  ...
  {
    return AnsibleDslPackage.Literals.ETASK_HANDLER_COMMON_KEYWORDS;
  }
  ...
  public NotificationChain basicSetError_handling(ETaskHandlerErrorHandling newError_handling, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ERROR_HANDLING, oldError_handling, newError_handling);
  ...
  public void setError_handling(ETaskHandlerErrorHandling newError_handling)
  {
    if (newError_handling != error_handling)
    {
      ...
      if (error_handling != null)
        msgs = ((InternalEObject)error_handling).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ERROR_HANDLING, null, msgs);
      if (newError_handling != null)
        msgs = ((InternalEObject)newError_handling).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ERROR_HANDLING, null, msgs);
      msgs = basicSetError_handling(newError_handling, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ERROR_HANDLING, newError_handling, newError_handling));
  }
  ...
  public void setAction(String newAction)
  {
    ...
    action = newAction;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ACTION, oldAction, action));
  }
  ...
  public NotificationChain basicSetAsynchronous_settings(EAsynchronousSettings newAsynchronous_settings, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ASYNCHRONOUS_SETTINGS, oldAsynchronous_settings, newAsynchronous_settings);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAsynchronous_settings(EAsynchronousSettings newAsynchronous_settings)
  {
    if (newAsynchronous_settings != asynchronous_settings)
    {
      ...
      if (asynchronous_settings != null)
        msgs = ((InternalEObject)asynchronous_settings).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ASYNCHRONOUS_SETTINGS, null, msgs);
      if (newAsynchronous_settings != null)
        msgs = ((InternalEObject)newAsynchronous_settings).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ASYNCHRONOUS_SETTINGS, null, msgs);
      msgs = basicSetAsynchronous_settings(newAsynchronous_settings, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ASYNCHRONOUS_SETTINGS, newAsynchronous_settings, newAsynchronous_settings));
  }
  ...
  public NotificationChain basicSetArgs(EDictionary newArgs, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ARGS, oldArgs, newArgs);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setArgs(EDictionary newArgs)
  {
    if (newArgs != args)
    {
      NotificationChain msgs = null;
      if (args != null)
        msgs = ((InternalEObject)args).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ARGS, null, msgs);
      if (newArgs != null)
        msgs = ((InternalEObject)newArgs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ARGS, null, msgs);
      msgs = basicSetArgs(newArgs, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ARGS, newArgs, newArgs));
  }
  ...
  public NotificationChain basicSetModule(EModuleCall newModule, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__MODULE, oldModule, newModule);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setModule(EModuleCall newModule)
  {
    if (newModule != module)
    {
      NotificationChain msgs = null;
      if (module != null)
        msgs = ((InternalEObject)module).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__MODULE, null, msgs);
      if (newModule != null)
        msgs = ((InternalEObject)newModule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__MODULE, null, msgs);
      msgs = basicSetModule(newModule, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__MODULE, newModule, newModule));
  }
  ...
  public NotificationChain basicSetLoop(ELoop newLoop, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__LOOP, oldLoop, newLoop);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLoop(ELoop newLoop)
  {
    if (newLoop != loop)
    {
      NotificationChain msgs = null;
      if (loop != null)
        msgs = ((InternalEObject)loop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__LOOP, null, msgs);
      if (newLoop != null)
        msgs = ((InternalEObject)newLoop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__LOOP, null, msgs);
      msgs = basicSetLoop(newLoop, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__LOOP, newLoop, newLoop));
  }
  ...
  public NotificationChain basicSetRegister(ERegisterVariable newRegister, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__REGISTER, oldRegister, newRegister);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRegister(ERegisterVariable newRegister)
  {
    if (newRegister != register)
    {
      NotificationChain msgs = null;
      if (register != null)
        msgs = ((InternalEObject)register).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__REGISTER, null, msgs);
      if (newRegister != null)
        msgs = ((InternalEObject)newRegister).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__REGISTER, null, msgs);
      msgs = basicSetRegister(newRegister, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__REGISTER, newRegister, newRegister));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ERROR_HANDLING:
        return basicSetError_handling(null, msgs);
      case AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ASYNCHRONOUS_SETTINGS:
        return basicSetAsynchronous_settings(null, msgs);
      case AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ARGS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ACTION:
        return getAction();
      case AnsibleDslPackage.ETASK_HANDLER_COMMON_KEYWORDS__ASYNCHRONOUS_SETTINGS:
...
} //ETaskHandlerCommonKeywordsImpl
