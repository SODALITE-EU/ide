...
public class AADMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AADMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRM_ModelAccess().getDataTypesAssignment_0_2(), "rule__RM_Model__DataTypesAssignment_0_2");
			builder.put(grammarAccess.getRM_ModelAccess().getArtifactTypesAssignment_1_2(), "rule__RM_Model__ArtifactTypesAssignment_1_2");
			builder.put(grammarAccess.getRM_ModelAccess().getCapabilityTypesAssignment_2_2(), "rule__RM_Model__CapabilityTypesAssignment_2_2");
			builder.put(grammarAccess.getRM_ModelAccess().getInterfaceTypesAssignment_3_2(), "rule__RM_Model__InterfaceTypesAssignment_3_2");
			builder.put(grammarAccess.getRM_ModelAccess().getRelationshipTypesAssignment_4_2(), "rule__RM_Model__RelationshipTypesAssignment_4_2");
			builder.put(grammarAccess.getRM_ModelAccess().getNodeTypesAssignment_5_2(), "rule__RM_Model__NodeTypesAssignment_5_2");
