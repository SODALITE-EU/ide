...
public class AADMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AADMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAADM_ModelAccess().getInputsAssignment_1_2(), "rule__AADM_Model__InputsAssignment_1_2");
			builder.put(grammarAccess.getAADM_ModelAccess().getNodeTemplatesAssignment_2_2(), "rule__AADM_Model__NodeTemplatesAssignment_2_2");
			...
			builder.put(grammarAccess.getRM_ModelAccess().getDataTypesAssignment_1_2(), "rule__RM_Model__DataTypesAssignment_1_2");
			builder.put(grammarAccess.getRM_ModelAccess().getArtifactTypesAssignment_2_2(), "rule__RM_Model__ArtifactTypesAssignment_2_2");
			builder.put(grammarAccess.getRM_ModelAccess().getCapabilityTypesAssignment_3_2(), "rule__RM_Model__CapabilityTypesAssignment_3_2");
			builder.put(grammarAccess.getRM_ModelAccess().getInterfaceTypesAssignment_4_2(), "rule__RM_Model__InterfaceTypesAssignment_4_2");
			builder.put(grammarAccess.getRM_ModelAccess().getRelationshipTypesAssignment_5_2(), "rule__RM_Model__RelationshipTypesAssignment_5_2");
			builder.put(grammarAccess.getRM_ModelAccess().getNodeTypesAssignment_6_2(), "rule__RM_Model__NodeTypesAssignment_6_2");
			builder.put(grammarAccess.getRM_ModelAccess().getPolicyTypesAssignment_7_2(), "rule__RM_Model__PolicyTypesAssignment_7_2");
