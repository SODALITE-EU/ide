...
public class AADMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AADMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getENodeTemplateBodyAccess().getGroup_7(), "rule__ENodeTemplateBody__Group_7__0");
			...
			builder.put(grammarAccess.getRM_ModelAccess().getGroup_7(), "rule__RM_Model__Group_7__0");
			builder.put(grammarAccess.getRM_ModelAccess().getGroup_8(), "rule__RM_Model__Group_8__0");
			builder.put(grammarAccess.getRM_ModelAccess().getGroup_9(), "rule__RM_Model__Group_9__0");
			...
			builder.put(grammarAccess.getEPolicyTypeBodyAccess().getGroup_4(), "rule__EPolicyTypeBody__Group_4__0");
			builder.put(grammarAccess.getETriggersAccess().getGroup(), "rule__ETriggers__Group__0");
			...
			builder.put(grammarAccess.getENodeTypeBodyAccess().getGroup_1_7(), "rule__ENodeTypeBody__Group_1_7__0");
			...
			builder.put(grammarAccess.getEImplementationAccess().getGroup(), "rule__EImplementation__Group__0");
			builder.put(grammarAccess.getEPrimaryAccess().getGroup(), "rule__EPrimary__Group__0");
			builder.put(grammarAccess.getEPrimaryAccess().getGroup_0(), "rule__EPrimary__Group_0__0");
			builder.put(grammarAccess.getEPrimaryAccess().getGroup_1(), "rule__EPrimary__Group_1__0");
			builder.put(grammarAccess.getEDependenciesAccess().getGroup(), "rule__EDependencies__Group__0");
			builder.put(grammarAccess.getEDependenciesAccess().getGroup_4(), "rule__EDependencies__Group_4__0");
			...
			builder.put(grammarAccess.getGetArtifactAccess().getGroup(), "rule__GetArtifact__Group__0");
			builder.put(grammarAccess.getGetArtifactBodyAccess().getGroup_0(), "rule__GetArtifactBody__Group_0__0");
			builder.put(grammarAccess.getGetArtifactBodyAccess().getGroup_1(), "rule__GetArtifactBody__Group_1__0");
			...
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getGroup_4(), "rule__ECapabilityDefinitionBody__Group_4__0");
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getGroup_5(), "rule__ECapabilityDefinitionBody__Group_5__0");
			...
			builder.put(grammarAccess.getEArtifactsAccess().getGroup(), "rule__EArtifacts__Group__0");
			builder.put(grammarAccess.getEArtifactDefinitionAccess().getGroup(), "rule__EArtifactDefinition__Group__0");
			builder.put(grammarAccess.getEArtifactDefinitionBodyAccess().getGroup_0(), "rule__EArtifactDefinitionBody__Group_0__0");
			builder.put(grammarAccess.getEArtifactDefinitionBodyAccess().getGroup_1(), "rule__EArtifactDefinitionBody__Group_1__0");
			...
			builder.put(grammarAccess.getENodeTemplateBodyAccess().getArtifactsAssignment_7_2(), "rule__ENodeTemplateBody__ArtifactsAssignment_7_2");
			...
			builder.put(grammarAccess.getRM_ModelAccess().getDescriptionAssignment_0_1(), "rule__RM_Model__DescriptionAssignment_0_1");
			builder.put(grammarAccess.getRM_ModelAccess().getModuleAssignment_1_1(), "rule__RM_Model__ModuleAssignment_1_1");
			builder.put(grammarAccess.getRM_ModelAccess().getImportsAssignment_2_1(), "rule__RM_Model__ImportsAssignment_2_1");
			builder.put(grammarAccess.getRM_ModelAccess().getDataTypesAssignment_3_2(), "rule__RM_Model__DataTypesAssignment_3_2");
			builder.put(grammarAccess.getRM_ModelAccess().getArtifactTypesAssignment_4_2(), "rule__RM_Model__ArtifactTypesAssignment_4_2");
			builder.put(grammarAccess.getRM_ModelAccess().getCapabilityTypesAssignment_5_2(), "rule__RM_Model__CapabilityTypesAssignment_5_2");
			builder.put(grammarAccess.getRM_ModelAccess().getInterfaceTypesAssignment_6_2(), "rule__RM_Model__InterfaceTypesAssignment_6_2");
			builder.put(grammarAccess.getRM_ModelAccess().getRelationshipTypesAssignment_7_2(), "rule__RM_Model__RelationshipTypesAssignment_7_2");
			builder.put(grammarAccess.getRM_ModelAccess().getNodeTypesAssignment_8_2(), "rule__RM_Model__NodeTypesAssignment_8_2");
			builder.put(grammarAccess.getRM_ModelAccess().getPolicyTypesAssignment_9_2(), "rule__RM_Model__PolicyTypesAssignment_9_2");
			...
			builder.put(grammarAccess.getEPolicyTypeBodyAccess().getTriggersAssignment_4_2(), "rule__EPolicyTypeBody__TriggersAssignment_4_2");
			builder.put(grammarAccess.getETriggersAccess().getTriggersAssignment_1(), "rule__ETriggers__TriggersAssignment_1");
			...
			builder.put(grammarAccess.getENodeTypeBodyAccess().getAttributesAssignment_1_3_2(), "rule__ENodeTypeBody__AttributesAssignment_1_3_2");
			builder.put(grammarAccess.getENodeTypeBodyAccess().getInterfacesAssignment_1_4_2(), "rule__ENodeTypeBody__InterfacesAssignment_1_4_2");
			builder.put(grammarAccess.getENodeTypeBodyAccess().getCapabilitiesAssignment_1_5_2(), "rule__ENodeTypeBody__CapabilitiesAssignment_1_5_2");
			...
			builder.put(grammarAccess.getENodeTypeBodyAccess().getArtifactsAssignment_1_7_2(), "rule__ENodeTypeBody__ArtifactsAssignment_1_7_2");
			...
			builder.put(grammarAccess.getERelationshipTypeBodyAccess().getAtributesAssignment_1_3_2(), "rule__ERelationshipTypeBody__AtributesAssignment_1_3_2");
			builder.put(grammarAccess.getERelationshipTypeBodyAccess().getInterfacesAssignment_1_4_2(), "rule__ERelationshipTypeBody__InterfacesAssignment_1_4_2");
			builder.put(grammarAccess.getERelationshipTypeBodyAccess().getValid_target_typesAssignment_1_5_2(), "rule__ERelationshipTypeBody__Valid_target_typesAssignment_1_5_2");
			...
			builder.put(grammarAccess.getEValidTargetTypesAccess().getTargetTypesAssignment_1_1(), "rule__EValidTargetTypes__TargetTypesAssignment_1_1");
			builder.put(grammarAccess.getETargetTypeAccess().getNameAssignment(), "rule__ETargetType__NameAssignment");
			...
			builder.put(grammarAccess.getEPropertyDefinitionBodyAccess().getConstraintsAssignment_5_2(), "rule__EPropertyDefinitionBody__ConstraintsAssignment_5_2");
			...
			builder.put(grammarAccess.getEOperationDefinitionBodyAccess().getImplementationAssignment_1_2_2(), "rule__EOperationDefinitionBody__ImplementationAssignment_1_2_2");
			builder.put(grammarAccess.getEImplementationAccess().getPrimaryAssignment_0(), "rule__EImplementation__PrimaryAssignment_0");
			builder.put(grammarAccess.getEImplementationAccess().getDependenciesAssignment_1(), "rule__EImplementation__DependenciesAssignment_1");
			builder.put(grammarAccess.getEPrimaryAccess().getFileAssignment_0_1(), "rule__EPrimary__FileAssignment_0_1");
			builder.put(grammarAccess.getEPrimaryAccess().getRelative_pathAssignment_1_2(), "rule__EPrimary__Relative_pathAssignment_1_2");
			builder.put(grammarAccess.getEDependenciesAccess().getFilesAssignment_2(), "rule__EDependencies__FilesAssignment_2");
			...
			builder.put(grammarAccess.getGetArtifactAccess().getArtifactAssignment_2(), "rule__GetArtifact__ArtifactAssignment_2");
			builder.put(grammarAccess.getGetArtifactBodyAccess().getArtifactAssignment_0_1(), "rule__GetArtifactBody__ArtifactAssignment_0_1");
			builder.put(grammarAccess.getGetArtifactBodyAccess().getEntityAssignment_1_1(), "rule__GetArtifactBody__EntityAssignment_1_1");
			...
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getValid_source_typesAssignment_4_2(), "rule__ECapabilityDefinitionBody__Valid_source_typesAssignment_4_2");
			...
			builder.put(grammarAccess.getERequirementDefinitionBodyAccess().getStartAssignment_3_2(), "rule__ERequirementDefinitionBody__StartAssignment_3_2");
			builder.put(grammarAccess.getERequirementDefinitionBodyAccess().getEndAssignment_3_4(), "rule__ERequirementDefinitionBody__EndAssignment_3_4");
			builder.put(grammarAccess.getEArtifactsAccess().getArtifactsAssignment_1(), "rule__EArtifacts__ArtifactsAssignment_1");
			builder.put(grammarAccess.getEArtifactDefinitionAccess().getNameAssignment_0(), "rule__EArtifactDefinition__NameAssignment_0");
			builder.put(grammarAccess.getEArtifactDefinitionAccess().getArtifactAssignment_3(), "rule__EArtifactDefinition__ArtifactAssignment_3");
			builder.put(grammarAccess.getEArtifactDefinitionBodyAccess().getTypeAssignment_0_1(), "rule__EArtifactDefinitionBody__TypeAssignment_0_1");
			builder.put(grammarAccess.getEArtifactDefinitionBodyAccess().getFileAssignment_1_1(), "rule__EArtifactDefinitionBody__FileAssignment_1_1");
			...
			builder.put(grammarAccess.getGetArtifactBodyAccess().getUnorderedGroup(), "rule__GetArtifactBody__UnorderedGroup");
			...
			builder.put(grammarAccess.getEArtifactDefinitionBodyAccess().getUnorderedGroup(), "rule__EArtifactDefinitionBody__UnorderedGroup");
		}
	}
