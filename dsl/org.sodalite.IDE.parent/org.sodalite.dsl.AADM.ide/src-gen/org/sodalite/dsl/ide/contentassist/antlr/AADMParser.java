...
public class AADMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AADMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getETriggerDefinitionBodyAccess().getTarget_filterAssignment_2_2(), "rule__ETriggerDefinitionBody__Target_filterAssignment_2_2");
			builder.put(grammarAccess.getETriggerDefinitionBodyAccess().getConditionAssignment_3_2(), "rule__ETriggerDefinitionBody__ConditionAssignment_3_2");
			builder.put(grammarAccess.getETriggerDefinitionBodyAccess().getActionAssignment_4_2(), "rule__ETriggerDefinitionBody__ActionAssignment_4_2");
