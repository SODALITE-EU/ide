...
public class AADMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AADMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getPropertiesAssignment_2_1(), "rule__ECapabilityDefinitionBody__PropertiesAssignment_2_1");
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getAttributesAssignment_3_1(), "rule__ECapabilityDefinitionBody__AttributesAssignment_3_1");
