...
public class AADMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AADMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAADM_ModelAccess().getModuleAssignment_0_1(), "rule__AADM_Model__ModuleAssignment_0_1");
			builder.put(grammarAccess.getAADM_ModelAccess().getImportsAssignment_1_1(), "rule__AADM_Model__ImportsAssignment_1_1");
			...
			builder.put(grammarAccess.getRM_ModelAccess().getImportsAssignment_1_1(), "rule__RM_Model__ImportsAssignment_1_1");
			builder.put(grammarAccess.getRM_ModelAccess().getDataTypesAssignment_2_2(), "rule__RM_Model__DataTypesAssignment_2_2");
			builder.put(grammarAccess.getRM_ModelAccess().getArtifactTypesAssignment_3_2(), "rule__RM_Model__ArtifactTypesAssignment_3_2");
			builder.put(grammarAccess.getRM_ModelAccess().getCapabilityTypesAssignment_4_2(), "rule__RM_Model__CapabilityTypesAssignment_4_2");
			builder.put(grammarAccess.getRM_ModelAccess().getInterfaceTypesAssignment_5_2(), "rule__RM_Model__InterfaceTypesAssignment_5_2");
			builder.put(grammarAccess.getRM_ModelAccess().getRelationshipTypesAssignment_6_2(), "rule__RM_Model__RelationshipTypesAssignment_6_2");
			builder.put(grammarAccess.getRM_ModelAccess().getNodeTypesAssignment_7_2(), "rule__RM_Model__NodeTypesAssignment_7_2");
			builder.put(grammarAccess.getRM_ModelAccess().getPolicyTypesAssignment_8_2(), "rule__RM_Model__PolicyTypesAssignment_8_2");
