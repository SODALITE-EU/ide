...
public class RMParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RMGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getValid_source_typesAssignment_2_2(), "rule__ECapabilityDefinitionBody__Valid_source_typesAssignment_2_2");
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getStartAssignment_3_2(), "rule__ECapabilityDefinitionBody__StartAssignment_3_2");
			builder.put(grammarAccess.getECapabilityDefinitionBodyAccess().getEndAssignment_3_4(), "rule__ECapabilityDefinitionBody__EndAssignment_3_4");
