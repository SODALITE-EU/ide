...
public class OptimizationParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OptimizationGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getELogicOperAccess().getAlternatives(), "rule__ELogicOper__Alternatives");
			builder.put(grammarAccess.getEValueAccess().getAlternatives(), "rule__EValue__Alternatives");
			builder.put(grammarAccess.getEComparisonOperatorAccess().getAlternatives(), "rule__EComparisonOperator__Alternatives");
			...
			builder.put(grammarAccess.getEOptBuildAccess().getGroup_1_0(), "rule__EOptBuild__Group_1_0__0");
			...
			builder.put(grammarAccess.getEAITrainingConfigAccess().getGroup_2_0(), "rule__EAITrainingConfig__Group_2_0__0");
			...
			builder.put(grammarAccess.getETensorFlowAccess().getGroup_1_0(), "rule__ETensorFlow__Group_1_0__0");
			...
			builder.put(grammarAccess.getEPyTorchAccess().getGroup_1_0(), "rule__EPyTorch__Group_1_0__0");
			...
			builder.put(grammarAccess.getEConstraintAccess().getGroup(), "rule__EConstraint__Group__0");
			...
			builder.put(grammarAccess.getEOptBuildAccess().getAcc_typeAssignment_1_0_1(), "rule__EOptBuild__Acc_typeAssignment_1_0_1");
			builder.put(grammarAccess.getEOptBuildAccess().getConstraintAssignment_1_1(), "rule__EOptBuild__ConstraintAssignment_1_1");
			...
			builder.put(grammarAccess.getEAITrainingConfigAccess().getDistributed_trainingAssignment_2_0_1(), "rule__EAITrainingConfig__Distributed_trainingAssignment_2_0_1");
			builder.put(grammarAccess.getEAITrainingConfigAccess().getConstraintAssignment_2_1(), "rule__EAITrainingConfig__ConstraintAssignment_2_1");
			...
			builder.put(grammarAccess.getEAITrainingDataAccess().getConstraintAssignment_4_1(), "rule__EAITrainingData__ConstraintAssignment_4_1");
			builder.put(grammarAccess.getEAITrainingDataAccess().getEtlAssignment_4_3(), "rule__EAITrainingData__EtlAssignment_4_3");
			...
			builder.put(grammarAccess.getETensorFlowAccess().getXlaAssignment_1_0_1(), "rule__ETensorFlow__XlaAssignment_1_0_1");
			builder.put(grammarAccess.getETensorFlowAccess().getConstraintAssignment_1_1(), "rule__ETensorFlow__ConstraintAssignment_1_1");
			builder.put(grammarAccess.getEPyTorchAccess().getVersionAssignment_0_1(), "rule__EPyTorch__VersionAssignment_0_1");
			builder.put(grammarAccess.getEPyTorchAccess().getGlowAssignment_1_0_1(), "rule__EPyTorch__GlowAssignment_1_0_1");
			builder.put(grammarAccess.getEPyTorchAccess().getConstraintAssignment_1_1(), "rule__EPyTorch__ConstraintAssignment_1_1");
			...
			builder.put(grammarAccess.getEOPENCLCaseAccess().getConstraintAssignment_1(), "rule__EOPENCLCase__ConstraintAssignment_1");
			builder.put(grammarAccess.getEOPENCLCaseAccess().getOpenclAssignment_3(), "rule__EOPENCLCase__OpenclAssignment_3");
			builder.put(grammarAccess.getEOPENACCCaseAccess().getConstraintAssignment_1(), "rule__EOPENACCCase__ConstraintAssignment_1");
			builder.put(grammarAccess.getEOPENACCCaseAccess().getOpenaccAssignment_3(), "rule__EOPENACCCase__OpenaccAssignment_3");
			...
			builder.put(grammarAccess.getEHPCDataAccess().getConstraintAssignment_4_1(), "rule__EHPCData__ConstraintAssignment_4_1");
			builder.put(grammarAccess.getEHPCDataAccess().getEtlAssignment_4_3(), "rule__EHPCData__EtlAssignment_4_3");
			...
			builder.put(grammarAccess.getEConstraintAccess().getStatementsAssignment_3(), "rule__EConstraint__StatementsAssignment_3");
			builder.put(grammarAccess.getEConstraintAccess().getLogicOpersAssignment_4_0(), "rule__EConstraint__LogicOpersAssignment_4_0");
			builder.put(grammarAccess.getEConstraintAccess().getStatementsAssignment_4_1(), "rule__EConstraint__StatementsAssignment_4_1");
			builder.put(grammarAccess.getEStatementAccess().getPropertyAssignment_0(), "rule__EStatement__PropertyAssignment_0");
			builder.put(grammarAccess.getEStatementAccess().getOperatorAssignment_1(), "rule__EStatement__OperatorAssignment_1");
			builder.put(grammarAccess.getEStatementAccess().getValueAssignment_2(), "rule__EStatement__ValueAssignment_2");
