...
import org.sodalite.dsl.kb_reasoner_client.json.CapabilityDefinitionJsonDeserializer;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.fasterxml.jackson.databind.annotation.JsonDeserialize;

@JsonIgnoreProperties(ignoreUnknown = true)
@JsonDeserialize(using = CapabilityDefinitionJsonDeserializer.class)
public class CapabilityDefinition extends KBEntity{
	SuperType type;
