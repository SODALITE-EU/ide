...
public class CapabilityDefinitionJsonDeserializer extends JsonDeserializer<CapabilityDefinition> {
    private static final ObjectMapper mapper = new ObjectMapper();
    protected JavaType nodeType;

	@Override
	public CapabilityDefinition deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
