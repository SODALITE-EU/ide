...
public class AnsibleDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_EModuleCall___BEGINTerminalRuleCall_3_0_ENDTerminalRuleCall_3_2__q;
	protected AbstractElementAlias match_EModuleCall___ENDTerminalRuleCall_3_1_1_3_ParametersKeyword_3_1_1_0_BEGINTerminalRuleCall_3_1_1_1__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_EModuleCall___BEGINTerminalRuleCall_3_0_ENDTerminalRuleCall_3_2__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getEModuleCallAccess().getBEGINTerminalRuleCall_3_0()), new TokenAlias(false, false, grammarAccess.getEModuleCallAccess().getENDTerminalRuleCall_3_2()));
		match_EModuleCall___ENDTerminalRuleCall_3_1_1_3_ParametersKeyword_3_1_1_0_BEGINTerminalRuleCall_3_1_1_1__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getEModuleCallAccess().getENDTerminalRuleCall_3_1_1_3()), new TokenAlias(false, false, grammarAccess.getEModuleCallAccess().getParametersKeyword_3_1_1_0()), new TokenAlias(false, false, grammarAccess.getEModuleCallAccess().getBEGINTerminalRuleCall_3_1_1_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_EModuleCall___BEGINTerminalRuleCall_3_0_ENDTerminalRuleCall_3_2__q.equals(syntax))
				emit_EModuleCall___BEGINTerminalRuleCall_3_0_ENDTerminalRuleCall_3_2__q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_EModuleCall___ENDTerminalRuleCall_3_1_1_3_ParametersKeyword_3_1_1_0_BEGINTerminalRuleCall_3_1_1_1__q.equals(syntax))
				emit_EModuleCall___ENDTerminalRuleCall_3_1_1_3_ParametersKeyword_3_1_1_0_BEGINTerminalRuleCall_3_1_1_1__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     firstPart=EStringWithoutQuotesPassed (ambiguity) (rule end)
	 *     secondPart=EStringWithoutQuotesPassed (ambiguity) (rule end)
	 *     thirdPart=EStringWithoutQuotesPassed (ambiguity) (rule end)
	 */
	protected void emit_EModuleCall___BEGINTerminalRuleCall_3_0_ENDTerminalRuleCall_3_2__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 */
	protected void emit_EModuleCall___ENDTerminalRuleCall_3_1_1_3_ParametersKeyword_3_1_1_0_BEGINTerminalRuleCall_3_1_1_1__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
