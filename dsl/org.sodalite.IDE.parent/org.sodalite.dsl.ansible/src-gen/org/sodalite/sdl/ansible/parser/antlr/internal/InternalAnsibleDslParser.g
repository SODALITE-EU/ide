...
@after {
	...
	(
		...
		{
			$current = $this_LocalNode_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleLocalNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLocalNodeRule()); }
	iv_ruleLocalNode=ruleLocalNode
	{ $current=$iv_ruleLocalNode.current; }
	EOF;

// Rule LocalNode
ruleLocalNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKBNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getKBNodeRule()); }
	iv_ruleKBNode=ruleKBNode
	{ $current=$iv_ruleKBNode.current; }
	EOF;

// Rule KBNode
ruleKBNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
					...
					{getUnorderedGroupHelper().canSelect(grammarAccess.getEModuleCallAccess().getUnorderedGroup_3_1(), 0)}?=>(
						{
							getUnorderedGroupHelper().select(grammarAccess.getEModuleCallAccess().getUnorderedGroup_3_1(), 0);
									...
									({true}?=>(otherlv_8=Direct_parameter
									{
...
entryRuleERoleName returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getERoleNameRule()); }
	iv_ruleERoleName=ruleERoleName
	{ $current=$iv_ruleERoleName.current; }
	EOF;

// Rule ERoleName
ruleERoleName returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleENumberOrStringWithoutQuotesPassed returns [EObject current=null]:
	...
	{ $current=$iv_ruleENumberOrStringWithoutQuotesPassed.current; }
	EOF;

// Rule ENumberOrStringWithoutQuotesPassed
ruleENumberOrStringWithoutQuotesPassed returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_EStringWithoutQuotesPassed_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ENumber_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleEJinjaOrStringWithoutQuotes returns [EObject current=null]:
	...
	{ $current=$iv_ruleEJinjaOrStringWithoutQuotes.current; }
	EOF;

// Rule EJinjaOrStringWithoutQuotes
ruleEJinjaOrStringWithoutQuotes returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		(
			(
				lv_stringWithoutQuotes_2_0=RULE_ID
				{
...
entryRuleEJinjaAndStringWithoutQuotes returns [EObject current=null]:
	...
	{ $current=$iv_ruleEJinjaAndStringWithoutQuotes.current; }
	EOF;

// Rule EJinjaAndStringWithoutQuotes
ruleEJinjaAndStringWithoutQuotes returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEStringWithoutQuotesPassed returns [EObject current=null]:
	...
	{ $current=$iv_ruleEStringWithoutQuotesPassed.current; }
	EOF;

// Rule EStringWithoutQuotesPassed
ruleEStringWithoutQuotesPassed returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_EJinjaAndStringWithoutQuotes_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleEValueWithString returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEValueWithStringRule()); }
	iv_ruleEValueWithString=ruleEValueWithString
	{ $current=$iv_ruleEValueWithString.current; }
	EOF;

// Rule EValueWithString
ruleEValueWithString returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_EStringWithoutQuotesPassed_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_EValueWithString_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleLocalEInputOperationVariableReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleLocalEInputOperationVariableReference.current; }
	EOF;

// Rule LocalEInputOperationVariableReference
ruleLocalEInputOperationVariableReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKBEInputOperationVariableReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleKBEInputOperationVariableReference.current; }
	EOF;

// Rule KBEInputOperationVariableReference
ruleKBEInputOperationVariableReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleLocalEInputInterfaceVariableReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleLocalEInputInterfaceVariableReference.current; }
	EOF;

// Rule LocalEInputInterfaceVariableReference
ruleLocalEInputInterfaceVariableReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleKBEInputInterfaceVariableReference returns [EObject current=null]:
	...
	{ $current=$iv_ruleKBEInputInterfaceVariableReference.current; }
	EOF;

// Rule KBEInputInterfaceVariableReference
ruleKBEInputInterfaceVariableReference returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleECollectionListPassed returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getECollectionListPassedRule()); }
	iv_ruleECollectionListPassed=ruleECollectionListPassed
	{ $current=$iv_ruleECollectionListPassed.current; }
	EOF;

// Rule ECollectionListPassed
ruleECollectionListPassed returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ECollectionList_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleECollectionList returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getECollectionListRule()); }
	iv_ruleECollectionList=ruleECollectionList
	{ $current=$iv_ruleECollectionList.current; }
	EOF;

// Rule ECollectionList
ruleECollectionList returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_ECollectionListInLine_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ECollectionListIndented_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleECollectionListInLine returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getECollectionListInLineRule()); }
	iv_ruleECollectionListInLine=ruleECollectionListInLine
	{ $current=$iv_ruleECollectionListInLine.current; }
	EOF;

// Rule ECollectionListInLine
ruleECollectionListInLine returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleECollectionFQN returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getECollectionFQNRule()); }
	iv_ruleECollectionFQN=ruleECollectionFQN
	{ $current=$iv_ruleECollectionFQN.current; }
	EOF;

// Rule ECollectionFQN
ruleECollectionFQN returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleECollectionListIndented returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getECollectionListIndentedRule()); }
	iv_ruleECollectionListIndented=ruleECollectionListIndented
	{ $current=$iv_ruleECollectionListIndented.current; }
	EOF;

// Rule ECollectionListIndented
ruleECollectionListIndented returns [EObject current=null]
@init {
	enterRule();
}
@after {
