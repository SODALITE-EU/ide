...
public class RMGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ERelationshipTypeBodyElements extends AbstractParserRuleElementFinder {
		...
		//{ERelationshipTypeBody} (('derived_from:' superType=[ERelationshipType|QUALIFIED_NAME])? & ('description:'
		//description=STRING)? & ('properties{' properties=EProperties '}')? & ('attributes{' atributes=EAttributes '}')? &
		//('interfaces{' interfaces=EInterfaces '}')? & ('valid_target_types:[' valid_target_types=EValidTargetTypes "]")?)
		public Group getGroup() { return cGroup; }
	...
	public class EParameterDefinitionBodyElements extends AbstractParserRuleElementFinder {
		...
		//('type:' type=[EDataType|EDataTypeName])? & ('value:' value=EValueExpression)? & ('default:' default=EValueExpression)?
		public UnorderedGroup getUnorderedGroup_1() { return cUnorderedGroup_1; }
	...
	public class ECapabilityDefinitionBodyElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cPropertiesEPropertiesParserRuleCall_2_1_0 = (RuleCall)cPropertiesAssignment_2_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_2_2 = (Keyword)cGroup_2.eContents().get(2);
		private final Group cGroup_3 = (Group)cUnorderedGroup.eContents().get(3);
		...
		private final RuleCall cAttributesEAttributesParserRuleCall_3_1_0 = (RuleCall)cAttributesAssignment_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_3_2 = (Keyword)cGroup_3.eContents().get(2);
		private final Group cGroup_4 = (Group)cUnorderedGroup.eContents().get(4);
		...
		//	'}')? & ('attributes{'
		//	attributes=EAttributes
		//	'}')? & ('valid_source_types:[' valid_source_types+=EValidSourceType? ']')? & ('occurrences:[' start=STRING ','
		//	end=STRING ']')?;
		@Override public ParserRule getRule() { return rule; }
		
		//'type:' type=[ECapabilityType|QUALIFIED_NAME] & ('description:' description=STRING)? & ('properties{'
		//properties=EProperties '}')? & ('attributes{' attributes=EAttributes '}')? & ('valid_source_types:['
		...
		//EProperties
		public RuleCall getPropertiesEPropertiesParserRuleCall_2_1_0() { return cPropertiesEPropertiesParserRuleCall_2_1_0; }
		...
		//EAttributes
		public RuleCall getAttributesEAttributesParserRuleCall_3_1_0() { return cAttributesEAttributesParserRuleCall_3_1_0; }
