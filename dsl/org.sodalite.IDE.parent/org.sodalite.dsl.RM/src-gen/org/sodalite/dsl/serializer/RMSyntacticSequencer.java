...
public class RMSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ELIST___CommaKeyword_1_0_STRINGTerminalRuleCall_1_1__a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ELIST___CommaKeyword_1_0_STRINGTerminalRuleCall_1_1__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getELISTAccess().getCommaKeyword_1_0()), new TokenAlias(false, false, grammarAccess.getELISTAccess().getSTRINGTerminalRuleCall_1_1()));
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_ELIST___CommaKeyword_1_0_STRINGTerminalRuleCall_1_1__a.equals(syntax))
				emit_ELIST___CommaKeyword_1_0_STRINGTerminalRuleCall_1_1__a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     list+=STRING (ambiguity) (rule end)
	 */
	protected void emit_ELIST___CommaKeyword_1_0_STRINGTerminalRuleCall_1_1__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
