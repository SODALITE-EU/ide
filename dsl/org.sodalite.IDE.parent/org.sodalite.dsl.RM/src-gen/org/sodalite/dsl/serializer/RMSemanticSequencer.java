...
public class RMSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_EInRange(ISerializationContext context, EInRange semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEInRangeAccess().getStartSTRINGTerminalRuleCall_1_0(), semanticObject.getStart());
		feeder.accept(grammarAccess.getEInRangeAccess().getEndSTRINGTerminalRuleCall_3_0(), semanticObject.getEnd());
		feeder.finish();
	}
