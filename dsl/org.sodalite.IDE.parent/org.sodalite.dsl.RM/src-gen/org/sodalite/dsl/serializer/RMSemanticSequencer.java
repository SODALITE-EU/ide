...
public class RMSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == RMPackage.eINSTANCE)
			...
			case RMPackage.ETYPE_REF:
				sequence_ETypeRef(context, (ETypeRef) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     ((type=[ECapabilityType|QUALIFIED_NAME] | description=STRING | valid_source_types+=EValidSourceType)? (start=STRING end=STRING)?)+
	 */
	 ...
	 *
	 * Constraint:
	 *     (description=STRING | inputs=EInputs | implementation=STRING)*
	 */
	...
	/**
	 * Contexts:
	 *     ETypeRef returns ETypeRef
	 *
	 * Constraint:
	 *     name=[ENodeType|QUALIFIED_NAME]
	 */
	protected void sequence_ETypeRef(ISerializationContext context, ETypeRef semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, RMPackage.Literals.ETYPE_REF__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, RMPackage.Literals.ETYPE_REF__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getETypeRefAccess().getNameENodeTypeQUALIFIED_NAMETerminalRuleCall_0_1(), semanticObject.eGet(RMPackage.Literals.ETYPE_REF__NAME, false));
		feeder.finish();
	}
	...
	protected void sequence_GetProperty(ISerializationContext context, GetProperty semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getGetPropertyAccess().getPropertyGetPropertyBodyParserRuleCall_1_0(), semanticObject.getProperty());
		feeder.finish();
	}
