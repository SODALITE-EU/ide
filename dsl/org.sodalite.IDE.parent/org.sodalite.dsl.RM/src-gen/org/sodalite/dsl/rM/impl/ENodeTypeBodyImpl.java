...
public class ENodeTypeBodyImpl extends MinimalEObjectImpl.Container implements ENodeTypeBody
{
  ...
  public NotificationChain basicSetSuperType(EPREFIX_TYPE newSuperType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RMPackage.ENODE_TYPE_BODY__SUPER_TYPE, oldSuperType, newSuperType);
  ...
  public void setSuperType(EPREFIX_TYPE newSuperType)
  {
    if (newSuperType != superType)
    {
      ...
      if (superType != null)
        msgs = ((InternalEObject)superType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RMPackage.ENODE_TYPE_BODY__SUPER_TYPE, null, msgs);
      if (newSuperType != null)
        msgs = ((InternalEObject)newSuperType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RMPackage.ENODE_TYPE_BODY__SUPER_TYPE, null, msgs);
      msgs = basicSetSuperType(newSuperType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RMPackage.ENODE_TYPE_BODY__SUPER_TYPE, newSuperType, newSuperType));
  }
