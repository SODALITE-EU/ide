 ...
 * </p>
 * <ul>
 *   <li>{@link org.sodalite.dsl.rM.impl.EAssertionDefinitionImpl#getAttribute_name <em>Attribute name</em>}</li>
 *   <li>{@link org.sodalite.dsl.rM.impl.EAssertionDefinitionImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EAssertionDefinitionImpl extends MinimalEObjectImpl.Container implements EAssertionDefinition
{
  ...
  {
    return RMPackage.Literals.EASSERTION_DEFINITION;
  }
  ...
  public void setAttribute_name(String newAttribute_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RMPackage.EASSERTION_DEFINITION__ATTRIBUTE_NAME, oldAttribute_name, attribute_name));
  }
  ...
  public NotificationChain basicSetConstraints(EConstraintList newConstraints, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RMPackage.EASSERTION_DEFINITION__CONSTRAINTS, oldConstraints, newConstraints);
  ...
  public void setConstraints(EConstraintList newConstraints)
  {
    if (newConstraints != constraints)
    {
      ...
      if (constraints != null)
        msgs = ((InternalEObject)constraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RMPackage.EASSERTION_DEFINITION__CONSTRAINTS, null, msgs);
      if (newConstraints != null)
        msgs = ((InternalEObject)newConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RMPackage.EASSERTION_DEFINITION__CONSTRAINTS, null, msgs);
      msgs = basicSetConstraints(newConstraints, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RMPackage.EASSERTION_DEFINITION__CONSTRAINTS, newConstraints, newConstraints));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RMPackage.EASSERTION_DEFINITION__CONSTRAINTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RMPackage.EASSERTION_DEFINITION__ATTRIBUTE_NAME:
