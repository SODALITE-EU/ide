 ...
 * </p>
 * <ul>
 *   <li>{@link org.sodalite.dsl.aADM.impl.EInputsImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EInputsImpl extends MinimalEObjectImpl.Container implements EInputs
{
  ...
  {
    return AADMPackage.Literals.EINPUTS;
  }
  ...
  public EList<EParameterDefinition> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<EParameterDefinition>(EParameterDefinition.class, this, AADMPackage.EINPUTS__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AADMPackage.EINPUTS__PARAMETERS:
