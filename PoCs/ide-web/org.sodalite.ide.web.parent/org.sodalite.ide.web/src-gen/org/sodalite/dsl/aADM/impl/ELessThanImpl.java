 ...
 * </p>
 * <ul>
 *   <li>{@link org.sodalite.dsl.aADM.impl.ELessThanImpl#getVal <em>Val</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ELessThanImpl extends EConstraintImpl implements ELessThan
{
  ...
  {
    return AADMPackage.Literals.ELESS_THAN;
  }
  ...
  public NotificationChain basicSetVal(EAlphaNumericValue newVal, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AADMPackage.ELESS_THAN__VAL, oldVal, newVal);
  ...
  public void setVal(EAlphaNumericValue newVal)
  {
    if (newVal != val)
    {
      ...
      if (val != null)
        msgs = ((InternalEObject)val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AADMPackage.ELESS_THAN__VAL, null, msgs);
      if (newVal != null)
        msgs = ((InternalEObject)newVal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AADMPackage.ELESS_THAN__VAL, null, msgs);
      msgs = basicSetVal(newVal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AADMPackage.ELESS_THAN__VAL, newVal, newVal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AADMPackage.ELESS_THAN__VAL:
