 ...
 * </p>
 * <ul>
 *   <li>{@link org.sodalite.dsl.aADM.impl.EOutputsImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EOutputsImpl extends MinimalEObjectImpl.Container implements EOutputs
{
   ...
   * @ordered
   */
  protected EList<EParameterDefinition> parameters;
  ...
  {
    return AADMPackage.Literals.EOUTPUTS;
  }
   ...
   */
  @Override
  public EList<EParameterDefinition> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<EParameterDefinition>(EParameterDefinition.class, this, AADMPackage.EOUTPUTS__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AADMPackage.EOUTPUTS__PARAMETERS:
