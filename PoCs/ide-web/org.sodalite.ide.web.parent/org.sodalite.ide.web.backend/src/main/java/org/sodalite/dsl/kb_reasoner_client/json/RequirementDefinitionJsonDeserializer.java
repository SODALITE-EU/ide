...
public class RequirementDefinitionJsonDeserializer extends JsonDeserializer<RequirementDefinition> {
    private static final ObjectMapper mapper = new ObjectMapper();
    protected JavaType nodeType;

	@Override
	public RequirementDefinition deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
